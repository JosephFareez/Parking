...
def test_route_status(web_client: FlaskClient, route: str) -> None:
    rv = web_client.get(route)
    assert rv.status_code == 200


def test_create_client(web_client: FlaskClient, db: SQLAlchemy) -> None:
    client_data = {
...
def test_create_parking(web_client: FlaskClient, db: SQLAlchemy) -> None:
    parking_data = {
...
def test_check_in_parking(web_client: FlaskClient, db: SQLAlchemy) -> None:
    client = Client(
        name="test_name_client_two",
        surname="test_surname_client_two",
...
def test_leaving_parking_lot(web_client: FlaskClient, db: SQLAlchemy) -> None:
...
def test_create_client_with_factory(web_client: FlaskClient, db: SQLAlchemy) -> None:
...
def test_create_parking_with_factory(web_client: FlaskClient, db: SQLAlchemy) -> None:
